...
import 'package:ganz_tek/generated/json/register_entity_helper.dart';
import 'package:ganz_tek/data/model/login_entity.dart';
import 'package:ganz_tek/generated/json/login_entity_helper.dart';
...
class JsonConvert<T> {
    ...
    switch (type) {			case RegisterEntity:
			...
			return loginUserRoleFromJson(data as LoginUserRole, json) as T;    }
    return data as T;
